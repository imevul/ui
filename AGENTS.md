...
[`docs/ROADMAP.md`](docs/ROADMAP.md) is the phase-level source of truth. P0–P3 and F-1–F-5 have landed. Next work is remaining Future (F-6 CI, F-7 monitor attach).
